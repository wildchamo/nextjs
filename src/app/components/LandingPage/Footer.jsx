  ...
  return (
    <footer className="bg-gradient-to-b from-[#0d5928]  to-header to-80%">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="gap-8 grid lg:grid-cols-3">
          <div className="flex flex-col justify-center items-center mb-5 sm:mb-0 md:justify-normal md:items-baseline">
            ...
            <p className="mt-4 max-w-xs text-background lg:w-[70%]">
              En nuestros más de 30 años de experiencia descubrimos lo necesario
              para ofrecerle el mejor portafolio acorde a sus necesidades,
              permitanos presentarle el mundo de oportunidades que hay frente a
              usted.
            </p>
            ...
            <ul className="mt-8 flex gap-6">
              ...
              <li>
                <a
                  href="https://www.instagram.com/mayaluna_seguros/?hl=es-la"
                  rel="noreferrer"
                  target="_blank"
                  className="text-background transition hover:opacity-75"
                >
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
            <div className="hidden md:block">
              <p className="font-medium text-background">Servicios</p>
            ...
            <div>
              <p className="font-medium text-background">Contacto</p>
        ...
        <p className="flex flex-col justify-center items-center md:items-baseline text-sm text-secondary">
          &copy; 2023 - Mayaluna Seguros | Todos los derechos reservados
        </p>
      </div>
    </footer>
  );
